...
public class BlackJack extends Hand {
	...
	public BlackJack(String[] suit, String[] rank, String[] deck, String handCard, int handValue, int dealerHandValue,
			String dealerHandCard, int bet, int money, String topCard) {
		super(suit, rank, deck, handCard, handValue, dealerHandValue, dealerHandCard, topCard);
		this.bet = bet;
		this.money = money;
	}
